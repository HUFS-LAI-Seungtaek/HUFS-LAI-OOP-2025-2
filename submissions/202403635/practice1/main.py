# 해당 파일은 수업시간 내에 모두 작성하지 못한 미완성 파일입니다.
import time
...
if __name__ == "__main__":
    ...
    for country, medal in tqdm(events, desc="Processing events"):
        ...
        if medal == "gold":
            countries[country] += Country(country, gold=1)
        elif medal == "silver":
            countries[country] += Country(country, silver=1)
        elif medal == "bronze":
            countries[country] += Country(country, bronze=1)
